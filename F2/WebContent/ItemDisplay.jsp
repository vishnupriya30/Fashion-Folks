...
<div class="w3-container">
  ...
  <a href="AfterLoginHomePage.jsp" style="margin-left:20% ;color:white;font-size:40px;font-family:Righteous;text-decoration:none">F2</a>
</td>
...
<form action="CartServlet?itemId=${item.itemId}" method="post">
Quantity:<select class="1-10" name="quantity"></select>
...
<button class="button" style="margin-top:-250px;margin-left:340px"><i class="fas fa-gift"></i>&nbsp&nbsp<a href='OrderServlet' style="color:white">Buy now</a></button></div>
